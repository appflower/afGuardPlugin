...
/**
 * afGuardRememberKey form base class.
 *
 * @method afGuardRememberKey getObject() Returns the current form's model object
 *
 * @package    ##PROJECT_NAME##
 * @subpackage form
 * @author     ##AUTHOR_NAME##
 */
abstract class BaseafGuardRememberKeyForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('af_guard_remember_key[%s]');
