...
abstract class BaseafGuardUserPeer
{
    ...
    const TABLE_NAME = 'af_guard_user';

    /** the related Propel class for this table */
    const OM_CLASS = 'afGuardUser';
    ...
    const USERNAME = 'af_guard_user.username';

    /** the column name for the algorithm field */
    const ALGORITHM = 'af_guard_user.algorithm';

    /** the column name for the salt field */
    const SALT = 'af_guard_user.salt';

    /** the column name for the password field */
    const PASSWORD = 'af_guard_user.password';

    /** the column name for the created_at field */
    const CREATED_AT = 'af_guard_user.created_at';

    /** the column name for the last_login field */
    const LAST_LOGIN = 'af_guard_user.last_login';

    /** the column name for the is_active field */
    const IS_ACTIVE = 'af_guard_user.is_active';
     ...
     * e.g. afGuardUserPeer::$fieldNames[afGuardUserPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (afGuardUserPeer::ID, afGuardUserPeer::USERNAME, afGuardUserPeer::ALGORITHM, afGuardUserPeer::SALT, afGuardUserPeer::PASSWORD, afGuardUserPeer::CREATED_AT, afGuardUserPeer::LAST_LOGIN, afGuardUserPeer::IS_ACTIVE, afGuardUserPeer::IS_SUPER_ADMIN, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. afGuardUserPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (afGuardUserPeer::ID => 0, afGuardUserPeer::USERNAME => 1, afGuardUserPeer::ALGORITHM => 2, afGuardUserPeer::SALT => 3, afGuardUserPeer::PASSWORD => 4, afGuardUserPeer::CREATED_AT => 5, afGuardUserPeer::LAST_LOGIN => 6, afGuardUserPeer::IS_ACTIVE => 7, afGuardUserPeer::IS_SUPER_ADMIN => 8, ),
    ...
    {
        $toNames = afGuardUserPeer::getFieldNames($toType);
        $key = isset(afGuardUserPeer::$fieldKeys[$fromType][$name]) ? afGuardUserPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(afGuardUserPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, afGuardUserPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return afGuardUserPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. afGuardUserPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(afGuardUserPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(afGuardUserPeer::TABLE_NAME);
        ...
        $criteria->setDbName(afGuardUserPeer::DATABASE_NAME); // Set the correct dbName
        ...
        {
          call_user_func($sf_hook, 'BaseafGuardUserPeer', $criteria, $con);
        }
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = afGuardUserPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return afGuardUserPeer::populateObjects(afGuardUserPeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(afGuardUserPeer::DATABASE_NAME);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables(self::getMixerPreSelectHook(__FUNCTION__)) as $sf_hook)
        {
          call_user_func($sf_hook, 'BaseafGuardUserPeer', $criteria, $con);
     ...
     *
     * @param      afGuardUser $obj A afGuardUser object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            afGuardUserPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A afGuardUser object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof afGuardUser) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or afGuardUser object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(afGuardUserPeer::$instances[$key]);
        }
     ...
     * @return   afGuardUser Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(afGuardUserPeer::$instances[$key])) {
                return afGuardUserPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (afGuardUserPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        afGuardUserPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to af_guard_user
    ...
    {
        return Propel::getDatabaseMap(afGuardUserPeer::DATABASE_NAME)->getTable(afGuardUserPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseafGuardUserPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseafGuardUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new afGuardUserTableMap());
      }
    }
    ...
    {
        return afGuardUserPeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from afGuardUser object
        }

        if ($criteria->containsKey(afGuardUserPeer::ID) && $criteria->keyContainsValue(afGuardUserPeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(afGuardUserPeer::DATABASE_NAME);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            afGuardUserPeer::clearInstancePool();
            afGuardUserPeer::clearRelatedInstancePool();
            $con->commit();
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof afGuardUser) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(afGuardUserPeer::DATABASE_NAME);
            $criteria->add(afGuardUserPeer::ID, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            if ($values instanceof Criteria) {
                ...
                afGuardUserPeer::removeInstanceFromPool($values);
            } else { // it's a primary key, or an array of pks
                foreach ((array) $values as $singleval) {
                    afGuardUserPeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = afGuardUserPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(afGuardUserPermissionPeer::USER_ID, $obj->getId());
            ...
            $criteria->add(afGuardUserGroupPeer::USER_ID, $obj->getId());
            $affectedRows += afGuardUserGroupPeer::doDelete($criteria, $con);

            // delete related afGuardRememberKey objects
    ...
    /**
     * Validates all modified columns of given afGuardUser object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      afGuardUser $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(afGuardUserPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(afGuardUserPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(afGuardUserPeer::DATABASE_NAME, afGuardUserPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = afGuardUserPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(afGuardUserPeer::DATABASE_NAME);
        $criteria->add(afGuardUserPeer::ID, $pk);

        $v = afGuardUserPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(afGuardUserPeer::DATABASE_NAME);
            $criteria->add(afGuardUserPeer::ID, $pks, Criteria::IN);
            $objs = afGuardUserPeer::doSelect($criteria, $con);
        }
    ...
    static private function getMixerPreSelectHook($method)
    {
      ...
      {
        return sprintf('BaseafGuardUserPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
      }
...
//
BaseafGuardUserPeer::buildTableMap();
