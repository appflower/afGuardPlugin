...
abstract class BaseafGuardUserPermissionPeer {
	...
	const CLASS_DEFAULT = 'plugins.afGuardPlugin.lib.model.afGuardUserPermission';
	 ...
	 *
	 * @param      afGuardUserPermission $value A afGuardUserPermission object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(afGuardUserPermission $obj, $key = null)
	{
	...
	public static function doSelectJoinafGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		afGuardUserPermissionPeer::addSelectColumns($criteria);
		$startcol = (afGuardUserPermissionPeer::NUM_COLUMNS - afGuardUserPermissionPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		afGuardUserPermissionPeer::addSelectColumns($criteria);
		$startcol2 = (afGuardUserPermissionPeer::NUM_COLUMNS - afGuardUserPermissionPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? afGuardUserPermissionPeer::CLASS_DEFAULT : afGuardUserPermissionPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a afGuardUserPermission or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a afGuardUserPermission or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the af_guard_user_permission table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a afGuardUserPermission or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(afGuardUserPermission $obj, $cols = null)
	{
		$columns = array();
