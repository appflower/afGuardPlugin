...
abstract class BaseafGuardGroupPermissionPeer {
	 ...
	 */
	public static function addInstanceToPool(afGuardGroupPermission $obj, $key = null)
	{
	...
	public static function doSelectJoinafGuardGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		afGuardGroupPermissionPeer::addSelectColumns($criteria);
		$startcol = (afGuardGroupPermissionPeer::NUM_COLUMNS - afGuardGroupPermissionPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		afGuardGroupPermissionPeer::addSelectColumns($criteria);
		$startcol2 = (afGuardGroupPermissionPeer::NUM_COLUMNS - afGuardGroupPermissionPeer::NUM_LAZY_LOAD_COLUMNS);

		afGuardGroupPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (afGuardGroupPeer::NUM_COLUMNS - afGuardGroupPeer::NUM_LAZY_LOAD_COLUMNS);

		afGuardPermissionPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (afGuardPermissionPeer::NUM_COLUMNS - afGuardPermissionPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAllExceptafGuardGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		afGuardPermissionPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (afGuardPermissionPeer::NUM_COLUMNS - afGuardPermissionPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	/**
	 * Method perform an INSERT on the database, given a afGuardGroupPermission or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseafGuardGroupPermissionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseafGuardGroupPermissionPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseafGuardGroupPermissionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseafGuardGroupPermissionPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a afGuardGroupPermission or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseafGuardGroupPermissionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseafGuardGroupPermissionPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(afGuardGroupPermissionPeer::GROUP_ID, $criteria->remove(afGuardGroupPermissionPeer::GROUP_ID), $comparison);

			$comparison = $criteria->getComparison(afGuardGroupPermissionPeer::PERMISSION_ID);
			$selectCriteria->add(afGuardGroupPermissionPeer::PERMISSION_ID, $criteria->remove(afGuardGroupPermissionPeer::PERMISSION_ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseafGuardGroupPermissionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseafGuardGroupPermissionPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the af_guard_group_permission table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(afGuardGroupPermissionPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a afGuardGroupPermission or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(afGuardGroupPermission $obj, $cols = null)
	{
		$columns = array();
