...
abstract class BaseafGuardGroupPermissionPeer
{
     ...
     * e.g. afGuardGroupPermissionPeer::$fieldNames[afGuardGroupPermissionPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('GroupId', 'PermissionId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('groupId', 'permissionId', ),
        BasePeer::TYPE_COLNAME => array (afGuardGroupPermissionPeer::GROUP_ID, afGuardGroupPermissionPeer::PERMISSION_ID, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. afGuardGroupPermissionPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('GroupId' => 0, 'PermissionId' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('groupId' => 0, 'permissionId' => 1, ),
        BasePeer::TYPE_COLNAME => array (afGuardGroupPermissionPeer::GROUP_ID => 0, afGuardGroupPermissionPeer::PERMISSION_ID => 1, ),
    ...
    {
        $toNames = afGuardGroupPermissionPeer::getFieldNames($toType);
        $key = isset(afGuardGroupPermissionPeer::$fieldKeys[$fromType][$name]) ? afGuardGroupPermissionPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(afGuardGroupPermissionPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, afGuardGroupPermissionPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return afGuardGroupPermissionPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(afGuardGroupPermissionPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(afGuardGroupPermissionPeer::DATABASE_NAME);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables(self::getMixerPreSelectHook(__FUNCTION__)) as $sf_hook)
        {
          call_user_func($sf_hook, 'BaseafGuardGroupPermissionPeer', $criteria, $con);
     ...
     *
     * @param      afGuardGroupPermission $obj A afGuardGroupPermission object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            afGuardGroupPermissionPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(afGuardGroupPermissionPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(afGuardGroupPermissionPeer::$instances[$key])) {
                return afGuardGroupPermissionPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (afGuardGroupPermissionPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        afGuardGroupPermissionPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = afGuardGroupPermissionPeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(afGuardGroupPermissionPeer::DATABASE_NAME)->getTable(afGuardGroupPermissionPeer::TABLE_NAME);
    }
    ...
    {
        return afGuardGroupPermissionPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(afGuardGroupPermissionPeer::DATABASE_NAME);
