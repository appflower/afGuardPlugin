...
abstract class BaseafGuardRememberKey extends BaseObject implements Persistent
{
     ...
     * @return afGuardRememberKey The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = afGuardRememberKeyPeer::USER_ID;
        }
    ...
    public function setRememberKey($v)
    {
        ...
        if ($this->remember_key !== $v) {
            $this->remember_key = $v;
            $this->modifiedColumns[] = afGuardRememberKeyPeer::REMEMBER_KEY;
        }
    ...
    public function setIpAddress($v)
    {
        ...
        if ($this->ip_address !== $v) {
            $this->ip_address = $v;
            $this->modifiedColumns[] = afGuardRememberKeyPeer::IP_ADDRESS;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = afGuardRememberKeyPeer::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = afGuardRememberKeyPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating afGuardRememberKey object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = afGuardRememberKeyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = afGuardRememberKeyQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseafGuardRememberKey:delete:pre') as $callable)
            {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseafGuardRememberKey:save:pre') as $callable)
            {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(afGuardRememberKeyPeer::CREATED_AT))
                {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseafGuardRememberKey:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                afGuardRememberKeyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(afGuardRememberKeyPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(afGuardRememberKeyPeer::REMEMBER_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`remember_key`';
        }
        if ($this->isColumnModified(afGuardRememberKeyPeer::IP_ADDRESS)) {
        ...
        $sql = sprintf(
            'INSERT INTO `af_guard_remember_key` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = afGuardRememberKeyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = afGuardRememberKeyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['afGuardRememberKey'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['afGuardRememberKey'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(afGuardRememberKeyPeer::USER_ID)) $criteria->add(afGuardRememberKeyPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(afGuardRememberKeyPeer::REMEMBER_KEY)) $criteria->add(afGuardRememberKeyPeer::REMEMBER_KEY, $this->remember_key);
        if ($this->isColumnModified(afGuardRememberKeyPeer::IP_ADDRESS)) $criteria->add(afGuardRememberKeyPeer::IP_ADDRESS, $this->ip_address);
        if ($this->isColumnModified(afGuardRememberKeyPeer::CREATED_AT)) $criteria->add(afGuardRememberKeyPeer::CREATED_AT, $this->created_at);
     ...
     * objects.
     *
     * @param object $copyObj An object of afGuardRememberKey (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return afGuardRememberKey Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return afGuardRememberKeyPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new afGuardRememberKeyPeer();
        }
    ...
    {
        return (string) $this->exportTo(afGuardRememberKeyPeer::DEFAULT_STRING_FORMAT);
    }
