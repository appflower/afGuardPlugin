...
$password=new afExtjsFieldPassword($col,array('name'=>'password','label'=>'Password','value'=>'','help'=>"Enter the password",'width'=>'150'));
$password=new afExtjsFieldPassword($col,array('name'=>'confirm_password','label'=>'Confirm Password','value'=>'','help'=>"The re-typed password, to ensure that it has been entered correctly.",'width'=>'150'));
