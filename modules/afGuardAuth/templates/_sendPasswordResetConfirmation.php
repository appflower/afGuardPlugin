...
<html>
    <head>
        ...
        <meta property="og:title" content="Welcome to your 30-day AppFlower demo account" />
      ...
      .rightColumnContent .link {
        ...
        font-size: 13px;
        color: #1a7501;
        background: url(http://www.appflower.com/images/email/blue_arrow.png) right 3px no-repeat;
        padding-right: 12px;
                                    	...
                                    	<tr>
                                        	<td valign="top" width="70" class="leftColumnContent">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                      <td valign="top">
															<img src="http://www.appflower.com/images/email/logo.png" alt="logo" width="75" height="230" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                          ...
                                                          <div>
															...
															<a class="link" href="<?php echo url_for('@af_guard_password_reset?validate='.$validate.'&uid='.$userObj->getId(), true) ?>"><?php echo url_for('@af_guard_password_reset?validate='.$validate.'&uid='.$userObj->getId(), true) ?></a>
                                                          ...
                                                          <img src="http://www.appflower.com/images/email/footer.png" alt="footer" width="486" height="31" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" valign="middle" id="social">
                                                            <div mc:edit="std_social">
                                                                &nbsp;<a href="http://www.twitter.com/#!/appflower/">follow on Twitter</a> | <a href="http://www.facebook.com/#!/pages/AppFlower/180819488621554">friend on Facebook</a> | <a href="mailto:info@appflower.com">email us</a>&nbsp;
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
